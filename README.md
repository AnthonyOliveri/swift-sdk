...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 1.1.2'
    pod 'IBMWatsonAssistantV2', '~> 1.1.2'
    pod 'IBMWatsonDiscoveryV1', '~> 1.1.2'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 1.1.2'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 1.1.2'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 1.1.2'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 1.1.2'
    pod 'IBMWatsonSpeechToTextV1', '~> 1.1.2'
    pod 'IBMWatsonTextToSpeechV1', '~> 1.1.2'
    pod 'IBMWatsonToneAnalyzerV3', '~> 1.1.2'
    pod 'IBMWatsonVisualRecognitionV3', '~> 1.1.2'
end
```
...
```
github "watson-developer-cloud/swift-sdk" ~> 1.1.2
```
...
```swift
dependencies: [
    .package(url: "https://github.com/watson-developer-cloud/swift-sdk", from: "1.1.2")
]
```
