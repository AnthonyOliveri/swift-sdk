...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 0.35.1'
    pod 'IBMWatsonConversationV1', '~> 0.35.1'
    pod 'IBMWatsonDiscoveryV1', '~> 0.35.1'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 0.35.1'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 0.35.1'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 0.35.1'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 0.35.1'
    pod 'IBMWatsonSpeechToTextV1', '~> 0.35.1'
    pod 'IBMWatsonTextToSpeechV1', '~> 0.35.1'
    pod 'IBMWatsonToneAnalyzerV3', '~> 0.35.1'
    pod 'IBMWatsonVisualRecognitionV3', '~> 0.35.1'
end
```
...
```
github "watson-developer-cloud/swift-sdk" ~> 0.35.1
```
...
```swift
dependencies: [
    .package(url: "https://github.com/watson-developer-cloud/swift-sdk", from: "0.35.1")
]
```
