...
target 'MyApp' do
    pod 'IBMWatsonAssistantV1', '~> 1.0.3'
    pod 'IBMWatsonConversationV1', '~> 1.0.3'
    pod 'IBMWatsonDiscoveryV1', '~> 1.0.3'
    pod 'IBMWatsonLanguageTranslatorV3', '~> 1.0.3'
    pod 'IBMWatsonNaturalLanguageClassifierV1', '~> 1.0.3'
    pod 'IBMWatsonNaturalLanguageUnderstandingV1', '~> 1.0.3'
    pod 'IBMWatsonPersonalityInsightsV3', '~> 1.0.3'
    pod 'IBMWatsonSpeechToTextV1', '~> 1.0.3'
    pod 'IBMWatsonTextToSpeechV1', '~> 1.0.3'
    pod 'IBMWatsonToneAnalyzerV3', '~> 1.0.3'
    pod 'IBMWatsonVisualRecognitionV3', '~> 1.0.3'
end
```
...
```
github "watson-developer-cloud/swift-sdk" ~> 1.0.3
```
...
```swift
dependencies: [
    .package(url: "https://github.com/watson-developer-cloud/swift-sdk", from: "1.0.3")
]
```
